<template>
  <div class="home aa">
    ...
    <div class=" container flex mb-5 flex-col items-center "> 
      <p class="m-7 text-5xl ...">Post your Article</p>
      <Form @submit="handlePost" :validation-schema="schema" class="  mt-5 p-5  ">
          ...
          <div class="form-group flex justify-center">
            <button type="submit" class="flex justify-center inline-flex items-center bg-yellow-500 text-grey-800 font-bold py-2 px-4 shadow-lg rounded-lg">
                Post
            </button>
          </div>
      </Form>
